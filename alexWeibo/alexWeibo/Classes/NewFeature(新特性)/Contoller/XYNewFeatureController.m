...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[XYNewFeatureCell class] forCellWithReuseIdentifier:ID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 3.没有注册，报错
    XYNewFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
